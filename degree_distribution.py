...
# plt.savefig('Degree distribution/contacts.png')
# plt.savefig('Degree distribution/commonfriends.png')
# plt.savefig('Degree distribution/commonsubscriptions.png')
# plt.savefig('Degree distribution/commonsubscribers.png')
plt.savefig('Degree distribution/commonfavoritevideos.png')
